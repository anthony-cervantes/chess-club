...
var styleTask = function (stylesPath, srcs) {
    return gulp.src(srcs.map(function (src) {
        return path.join('src/main/webapp/app', stylesPath, src);
    }))
...
gulp.task('jshint', function () {
    return gulp.src([
        ...
        'src/main/webapp/app/elements/**/*.js',
        'src/main/webapp/app/elements/**/*.html'
    ])
...
gulp.task('images', function () {
    return gulp.src('src/main/webapp/app/images/**/*')
        .pipe($.cache($.imagemin({
            progressive: true,
            interlaced: true
        })))
...
gulp.task('serve', ['styles', 'elements', 'images'], function () {
    ...
    browserSync({
        ...
        // https: true,
        server: {
            baseDir: ['.tmp', 'src/main/webapp/app'],
    ...
    gulp.watch(['src/main/webapp/app/**/*.html'], reload);
    gulp.watch(['src/main/webapp/app/styles/**/*.css'], ['styles', reload]);
    gulp.watch(['src/main/webapp/app/elements/**/*.css'], ['elements', reload]);
    gulp.watch(['src/main/webapp/app/{scripts,elements}/**/*.js'], ['jshint']);
    gulp.watch(['src/main/webapp/app/images/**/*'], reload);
});
